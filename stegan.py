"""PIL - Python Imaging Library/  10001011 = 139 while 00001011 = 11
                                  10001011 = 139 while 10001010 = 138
"""
from PIL import Image, ImageFont, ImageDraw
import textwrap

def decode_image(file_location="C:\Users\Navoda\Desktop\ImgProcessingProject\Source\encoded_image_tiger.png"):
    ...
    for i in range(x_size):
        for j in range(y_size):
            if bin(red_channel.getpixel((i, j)))[-1] == '0':
                ...
                pixels[i, j] = (0,0,0)
    decoded_image.save("C:\Users\Navoda\Desktop\ImgProcessingProject\Source\decoded_image_tiger.png")
...
def encode_image(text_to_encode, template_image="C:\Users\Navoda\Desktop\ImgProcessingProject\Source\image.jpg"):
    ...
    encoded_image.save("C:\Users\Navoda\Desktop\ImgProcessingProject\Source\encoded_image_tiger.png")
